...
import { Shield, Sparkles, X, AlertCircle, Clock, Zap } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await client.writeContract({
        ...
        args: [formData.url.trim(), formData.schema.trim(), parseInt(formData.duration, 10)],
        value: valWei,
        account: from,
      });
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-5">
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full p-2.5 border border-slate-300 rounded-lg text-xs font-mono focus:ring-2 focus:ring-sky-500 focus:border-sky-500 outline-none h-20 resize-none"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input 
                ...
                required 
              />
              <span className="text-[11px] text-slate-400 font-mono mt-1 block">~5000 blocks ≈ 1 week</span>
            </div>
            <div>
              <label className="block text-xs font-mono font-bold text-slate-700 mb-1">
                Coverage Escrow (GEN) *
              ...
              <input 
                ...
                required 
              />
              <span className="text-[11px] text-emerald-600 font-mono mt-1 block font-bold">100% Payout Pool</span>
            </div>
          </div>
